...
export const LeafletTacticalMap: React.FC<TacticalMapProps> = ({
  fleet,
  ports,
  zones,
  weatherGrid,
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Floating Basemap Switcher using shadcn DropdownMenu */}
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <span>Map: {basemapType === 'ocean' ? 'Ocean Base' : 'Satellite'}</span>
              <ChevronDown size={14} className="text-[#6b6660]" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-40 bg-[#faf8f5] border-[#ded9d2] text-[#1f1f1f] z-50">
            <DropdownMenuRadioGroup
              value={basemapType}
